...
const frenchTranslations = {
  ...
  'transportStops.mode.other': 'Transport public',
...
const germanTranslations: Record<TranslationKey, string> = {
  ...
  'transportStops.mode.other': 'Öffentlicher Verkehr',
...
const italianTranslations: Record<TranslationKey, string> = {
  ...
  'transportStops.mode.other': 'Trasporto pubblico',
...
const englishTranslations: Record<TranslationKey, string> = {
  ...
  'transportStops.mode.other': 'Public transport',
